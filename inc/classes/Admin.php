...
class Admin {
	...
	public function action_admin_page_menu() {
		add_theme_page( __( 'Theme Setup Help', 'inclusive' ), __( 'Theme Setup Help', 'inclusive' ), 'edit_theme_options', 'inclusive-theme', [ $this, 'docs' ] );
	}
	...
	public function action_admin_scripts( $hook ) {
		...
		wp_enqueue_script(
			'inclusive-copy',
			get_template_directory_uri() . '/assets/js/copy.js',
			array( 'clipboard' ),
			INCLUSIVE_VERSION,
			true
		);
	...
	public function docs() {
		...
		<div class="wrap">
			...
			<div class="welcome-panel-content">
				<h1><?php esc_html_e( 'Theme Setup Help', 'inclusive' ); ?></h1>
				<br>
				<?php esc_html_e( 'Thank you for using Inclusive.', 'inclusive' ); ?>
				<br>
				<?php esc_html_e( 'For support please email support@themesbycarolina.com.', 'inclusive' ); ?>
				<br><br>
			...
			<div class="welcome-panel">
			<div class="welcome-panel-content">
				<h2><?php esc_html_e( 'Custom Block Styles', 'inclusive' ); ?></h2>
				<br>
				...
				<ul>
					...
					<li><?php esc_html_e( 'Button: Large', 'inclusive' ); ?> <code>.wp-block-button.is-style-inclusive-large-button .wp-block-button__link</code></li>
			...
			<div class="welcome-panel">
			<div class="welcome-panel-content">
				<h2><?php esc_html_e( 'Block patterns', 'inclusive' ); ?></h2>
				<br>
				<?php esc_html_e( 'Block patterns are available in the editor if you have enabled Gutenberg. You can copy the patterns below if you do not want to install the plugin.', 'inclusive' ); ?>
				<br>
				...
				<ul>
					<li>
						<h3><?php esc_html_e( 'Heading with two colors', 'inclusive' ); ?></h3>
						<br>
						<img src="<?php echo esc_url( get_theme_file_uri( '/assets/images/heading-preview.png' ) ); ?>" alt="<?php esc_attr_e( 'A preview of a heading block with two colors, black and dark pink.', 'inclusive' ); ?>" width="300px">
						<br>
					...
					<li>
						<h3><?php esc_html_e( 'Cover block with background image, heading and button', 'inclusive' ); ?></h3>
						<br>
						<img src="<?php echo esc_url( get_theme_file_uri( '/assets/images/coverblock-preview.png' ) ); ?>" alt="<?php esc_attr_e( 'A preview of a cover block with a flower background image, a blue overlay, a heading and a button.', 'inclusive' ); ?>" width="300px">
						<br>
						<?php esc_html_e( 'Code:', 'inclusive' ); ?>
						<br>
					...
					<li>
						<h3><?php esc_html_e( 'Event list', 'inclusive' ); ?></h3>
						<br>
						<img src="<?php echo esc_url( get_theme_file_uri( '/assets/images/eventlist-preview.png' ) ); ?>" alt="<?php esc_attr_e( 'A preview of an event list with descriptions, date, live stream buttons, and separators between each event.', 'inclusive' ); ?>" width="400px">
						<br>
						<?php esc_html_e( 'Code:', 'inclusive' ); ?>
						<br>
